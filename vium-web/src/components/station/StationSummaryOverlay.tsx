...
import { X, MapPin, Zap, ArrowRight, Star } from 'lucide-react';
...
export const StationSummaryOverlay: React.FC<StationSummaryOverlayProps> = ({ 
  ...
  return (
    <div className="absolute bottom-4 left-3 right-3 z-30 animate-in slide-in-from-bottom-3 duration-300">
      <div className="bg-white/95 backdrop-blur-md rounded-[24px] shadow-2xl border border-white/50 p-4 flex flex-col gap-3 overflow-hidden relative max-w-lg mx-auto md:max-w-none">
        {/* 닫기 버튼 */}
        <button 
          onClick={onClose}
        ...
        <div className="flex items-end justify-between border-t border-gray-50 pt-2.5">
          ...
          <button 
            ...
            className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-xl text-[10px] font-black flex items-center gap-1.5 transition-all active:scale-95 shadow-md shadow-blue-100 whitespace-nowrap shrink-0"
          >
